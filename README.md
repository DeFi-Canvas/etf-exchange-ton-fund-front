...
- [most](https://www.npmjs.com/~most)

- [fp-ts](https://gcanti.github.io/fp-ts/)

- [frp-ts](https://www.npmjs.com/package/frp-ts)
...
- `api:codegen` - Generates code for queries based on the swager schema
- `prettier:write` - converts files according to the codestyle
