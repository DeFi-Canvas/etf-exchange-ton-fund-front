...
const screens = [
    {
        ...
        text: (
            <p>
                <span>Welcome to DeFi Canvas!</span>
                <br /> Investing is now as easy as making a tap
            </p>
        ),
        button: (onClick: () => void) => (
            <ButtonPrimary text={'Continue'} onClick={onClick} />
        ),
    },
    {
        img: second_step,
        text: (
            <p>
                <span>Simple one-click</span> investing in indices, deposits and
                modern instruments
            </p>
        ),
        button: (onClick: () => void) => (
    ...
    },
    {
        ...
        text: (
            <p>
                <span>Connect your wallet</span> and plunge into the world of
                investments now
            </p>
        ),
        button: (onClick: () => void) => (
            <ButtonPrimary
                text={'Connect wallet'}
                className={'onboard-screen--button'}
                onClick={onClick}
            />
        ),
    ...
    return (
        <div className={'onboard-screen'}>
            <img
                src={screenData.img}
                alt="image"
                className={'onboard-screen--image'}
            />
            <div className={'onboard-screen--content'}>{screenData.text}</div>
            <div className={'onboard-screen--button'}>
                {screenData?.secondaryButton &&
                    screenData.secondaryButton(onSecondaryClick)}
