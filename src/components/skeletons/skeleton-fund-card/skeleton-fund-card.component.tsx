        ...
        <div className={css.card}>
            <header className={css.cardHeader}>
                ...
                <div>
                    ...
                    <SkeletonCardLine className={css.cardHeaderSubTitle} height={22} />
                    <SkeletonCardLine className={css.cardHeaderButton} height={22} />
                </div>
            </header>
            <div className={css.cardBody}>
                <SkeletonCardLine height={26} />
                <SkeletonCardLine height={21} className={css.cardBodySubTitle} />
