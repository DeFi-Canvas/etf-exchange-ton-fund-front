...
// export const callContract = createAsyncThunk(
//     'app/callContract',
//     async (
//         {
//             tonui,
...
//                     {
//                         address:
//                             'EQDwAUGq_KM0Aa5clRch8gkcUWqknVC0aH2i0E1AoP4RXq_q',
...
//                     !balance ||
//                     balance?.length !== 3 ||
//                     balance.some((b: Balance) => b.balance === '0')
//                 ) {
...
//                     beginCell()
//                         .storeAddress(
//                             address(jettons_balance[0].wallet_address.address)
//                         )
//                         .storeCoins(BigInt(jettons_balance[0].balance))
//                         .endCell()
//                 )
//                 .set(
//                     1,
//                     beginCell()
//                         .storeAddress(
//                             address(jettons_balance[1].wallet_address.address)
//                         )
//                         .storeCoins(BigInt(jettons_balance[1].balance))
//                         .endCell()
//                 )
//                 .set(
//                     2,
//                     beginCell()
//                         .storeAddress(
//                             address(jettons_balance[2].wallet_address.address)
//                         )
//                         .storeCoins(BigInt(jettons_balance[2].balance))
//                         .endCell()
//                 );
...
//                 let wallet_info = await dispatch(
//                     fetchWalletInfoTC({ address: wallet! })
//                 ).then(
//                     (res) =>
//                         res.payload as {
//                             balance: number;
...
//                 const prevLPBalance = prevWalletJettons?.find(
//                     (j) =>
//                         j?.jetton ===
//                         '0:f00141aafca33401ae5c951721f2091c516aa49d50b4687da2d04d40a0fe115e'
//                 )?.balance;
...
//     'app/sendUserData',
//     async (
//         userData: { id: number | string; userName: string },
