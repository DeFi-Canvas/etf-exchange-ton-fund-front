...
//     const { wallet_info, selectedCoinToInvest } = useAppSelector(
//         (state) => state.appSlice
//     );
//     const tonBalance = wallet_info?.balance?.toFixed(2) || 0;
//     const usdtBalance =
//         wallet_info?.jettons?.find((el) => el.symbol === 'USDT')?.balance || 0;
//     const dogsBalance =
//         wallet_info?.jettons?.find((el) => el.symbol === 'DOGS')?.balance || 0;

//     const handleCoinClick = (symbol: string) => {
//         dispatch(
//             selectedCoinToInvest === symbol
//                 ? setSelectedCoinToInvest('')
//                 : setSelectedCoinToInvest(symbol)
//         );
//     };
...
//                 <p>
//                     Choose your preferred token for secure and transparent fund
//                     investment
//                 </p>
//             </div>
...
//                 <RowWithImage
//                     className={'row-with-image--white'}
//                     title={'TON'}
//                     image={ton}
//                     subTitle={'Toncoin'}
//                     disabled={!tonBalance}
//                     numbers={tonBalance}
//                     onClick={() => handleCoinClick('TON')}
