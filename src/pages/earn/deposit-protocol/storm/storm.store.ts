    ...
    (waletService): NewStormStore =>
        () => {
            ...
            const getAssetEffect = pipe(
                ...
                tap((assetsResponce) => {
                    const newAssets = pipe(
                        ...
                        E.chain(
                            flow(
                                A.findFirst((asset) => asset.ticker === 'TON'),
            ...
            return valueWithEffect.new(
                { asset, activeAction, setActiveAction: activeAction.set },
                getAssetEffect
            );
        }
);
export const newStormStore = injectable(newWaletRestService, () => Store({}));
