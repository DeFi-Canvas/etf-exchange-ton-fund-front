    ...
    return (
        <div className={css.card}>
            ...
            <div className={css.cardContent}>
                A DeFi fund is a decentralized financial investment vehicle built 
                on blockchain technology. It enables users to pool capital 
                and invest in a range of decentralized finance (DeFi) protocols, 
                earning returns through yield farming, liquidity provision, 
                staking, and other innovative mechanisms. The fund operates without 
                intermediaries, offering transparency, security, and global accessibility.
            </div>
            <div className={css.cardInfoWrapper}>
                <div className={css.cardInfoItem}>
                    ...
                    <div className={css.cardInfoItemContent}>
                        ...
                        <div className={css.cardInfoSubTitle}>Compared to meme coins</div>
                    </div>
                </div>   
                <div className={css.cardInfoItem}>
                    ...
                    <div className={css.cardInfoItemContent}>
                        ...
                        <div className={css.cardInfoSubTitle}>Coins exchange fee</div>
                    </div>
                </div>       
            </div>
        </div>
