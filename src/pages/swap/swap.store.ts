...
export const newSwapStore = injectable(
    ...
    AssetsRestService,
    (walletService, swapRestService, i18n, assetsRestService) =>
        (): NewSwapStore => {
            const { details: i18nDetails, result: i18nResult } =
                i18n.Swap.get();
            //#region Atoms
            const {
                state: allAssets,
            ...
            const [onSearchAssets, onSearchAssetsEvent] =
                createAdapter<string>();
            ...
            //#region Functions
            const closeResultBottomSheet = () =>
                resultBottomSheetIsOpen.set(false);
